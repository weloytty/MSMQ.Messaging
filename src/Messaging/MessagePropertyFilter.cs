...
namespace MSMQ.Messaging
{
    ...
    public class MessagePropertyFilter : ICloneable
    {
        ...
        ///    </para>
        /// </devdoc>
        [DefaultValue(MessagePropertyFilter.defaultBodySize), MessagingDescription(Res.MsgDefaultBodySize)]
        ...
        ///    </para>
        /// </devdoc>
        [DefaultValue(MessagePropertyFilter.defaultExtensionSize), MessagingDescription(Res.MsgDefaultExtensionSize)]
        ...
        ///    </para>
        /// </devdoc>
        [DefaultValue(MessagePropertyFilter.defaultLabelSize), MessagingDescription(Res.MsgDefaultLabelSize)]
