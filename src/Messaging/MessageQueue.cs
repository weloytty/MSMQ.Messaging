...
namespace MSMQ.Messaging
{
    ...
    public class MessageQueue : Component, IEnumerable
    {
        ...
        ///       constructor, the <see cref='MessageQueue.Path'/>
        ...
        /// <devdoc>
        ///    <para>
        ///       Gets or sets the queue's path. When setting the <see cref='MessageQueue.Path'/>, this points the <see cref='MessageQueue'/>
        ///       to a new queue.
        ///    </para>
        /// </devdoc>         
        [Editor("System.Messaging.Design.QueuePathEditor", "System.Drawing.Design.UITypeEditor, " + AssemblyRef.SystemDrawing),
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>       
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "0#dacl")]
